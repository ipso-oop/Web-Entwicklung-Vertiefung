...
// Event Handler für Message Bus Events
messageBus.subscribe('contact.created', (contact) => {
    console.log('Neuer Kontakt erstellt:', contact);
    // Hier können weitere Aktionen ausgeführt werden, z.B.:
...
messageBus.subscribe('contact.deleted', (contactId) => {
    console.log('Kontakt gelöscht:', contactId);
});
...
app.post('/api/v1/contacts', (req, res) => {
    try {
        ...
        messageBus.publish('contactCreated', newContact);
...
app.put('/api/v1/contacts/:id', (req, res) => {
    try {
        ...
        // Event über Message Bus veröffentlichen
        messageBus.publish('contactUpdated', updatedContact);
...
app.delete('/api/v1/contacts/:id', (req, res) => {
    try {
        ...
        // Event über Message Bus veröffentlichen
        messageBus.publish('contactDeleted', deletedContactId);
